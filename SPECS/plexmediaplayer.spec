...
Source0:        https://github.com/plexinc/plex-media-player/archive/v1.3.2.657-21cb31b8.tar.gz#/%{name}-%{version}.tar.gz
...
%setup -n plex-media-player-1.3.2.657-21cb31b8 -q
%patch0 -p0
